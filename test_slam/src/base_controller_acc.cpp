...
void cmd_velCallback(const geometry_msgs::Twist &twist_aux)
{
    ...
    Union_Speed.Struct_Speed.slam_vx = twist_aux.linear.y*1.0;
    Union_Speed.Struct_Speed.slam_vy = twist_aux.linear.x*(-1.0);
    Union_Speed.Struct_Speed.slam_vz = twist_aux.angular.z*(-0.4);
